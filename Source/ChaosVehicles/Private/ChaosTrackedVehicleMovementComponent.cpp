...
FTrackedVehicleDebugParams GTrakcedVehicleDebugParams;
extern FVehicleDebugParams GVehicleDebugParams;

EDebugPages UChaosTrackedVehicleMovementComponent::DebugPage = EDebugPages::BasicPage;

FAutoConsoleVariableRef CVarChaosVehiclesShowWheelCollisionNormal(TEXT("p.Vehicle.ShowWheelCollisionNormal"), GTrakcedVehicleDebugParams.ShowTrackCollisionNormal, TEXT("Enable/Disable Wheel Collision Normal Visualisation."));
FAutoConsoleVariableRef CVarChaosVehiclesShowSuspensionRaycasts(TEXT("p.Vehicle.ShowSuspensionRaycasts"), GTrakcedVehicleDebugParams.ShowSuspensionRaycasts, TEXT("Enable/Disable Suspension Raycast Visualisation."));
FAutoConsoleVariableRef CVarChaosVehiclesShowSuspensionLimits(TEXT("p.Vehicle.ShowSuspensionLimits"), GTrakcedVehicleDebugParams.ShowSuspensionLimits, TEXT("Enable/Disable Suspension Limits Visualisation."));
FAutoConsoleVariableRef CVarChaosVehiclesShowWheelForces(TEXT("p.Vehicle.ShowWheelForces"), GTrakcedVehicleDebugParams.ShowTrackForces, TEXT("Enable/Disable Wheel Forces Visualisation."));
FAutoConsoleVariableRef CVarChaosVehiclesShowSuspensionForces(TEXT("p.Vehicle.ShowSuspensionForces"), GTrakcedVehicleDebugParams.ShowSuspensionForces, TEXT("Enable/Disable Suspension Forces Visualisation."));
FAutoConsoleVariableRef CVarChaosVehiclesShowBatchQueryExtents(TEXT("p.Vehicle.ShowBatchQueryExtents"), GTrakcedVehicleDebugParams.ShowBatchQueryExtents, TEXT("Enable/Disable Suspension Forces Visualisation."));
FAutoConsoleVariableRef CVarChaosVehiclesShowRaycastComponent(TEXT("p.Vehicle.ShowRaycastComponent"), GTrakcedVehicleDebugParams.ShowRaycastComponent, TEXT("Enable/Disable Raycast Component Hit Visualisation."));
FAutoConsoleVariableRef CVarChaosVehiclesShowRaycastMaterial(TEXT("p.Vehicle.ShowRaycastMaterial"), GTrakcedVehicleDebugParams.ShowRaycastMaterial, TEXT("Enable/Disable Raycast Material Hit Visualisation."));
FAutoConsoleVariableRef CVarChaosVehiclesTraceTypeOverride(TEXT("p.Vehicle.TraceTypeOverride"), GTrakcedVehicleDebugParams.TraceTypeOverride, TEXT("Override ray trace type, 1=Simple, 2=Complex."));
FAutoConsoleVariableRef CVarChaosVehiclesCacheSuspensionOffset(TEXT("p.Vehicle.CacheSuspensionOffset"), GTrakcedVehicleDebugParams.CacheSuspensionOffset, TEXT("Cache Trace For Animation Optimization"));

FAutoConsoleVariableRef CVarChaosVehiclesDisableSuspensionForces(TEXT("p.Vehicle.DisableSuspensionForces"), GTrakcedVehicleDebugParams.DisableSuspensionForces, TEXT("Enable/Disable Suspension Forces."));
FAutoConsoleVariableRef CVarChaosVehiclesDisableFrictionForces(TEXT("p.Vehicle.DisableFrictionForces"), GTrakcedVehicleDebugParams.DisableFrictionForces, TEXT("Enable/Disable Wheel Friction Forces."));
FAutoConsoleVariableRef CVarChaosVehiclesDisableRollbarForces(TEXT("p.Vehicle.DisableRollbarForces"), GTrakcedVehicleDebugParams.DisableRollbarForces, TEXT("Enable/Disable Rollbar Forces."));
FAutoConsoleVariableRef CVarChaosVehiclesDisableConstraintSuspension(TEXT("p.Vehicle.DisableConstraintSuspension"), GTrakcedVehicleDebugParams.DisableConstraintSuspension, TEXT("Enable/Disable Constraint based suspension, swaps to basic force based suspension without hardstops instead."));

FAutoConsoleVariableRef CVarChaosVehiclesThrottleOverride(TEXT("p.Vehicle.ThrottleOverride"), GTrakcedVehicleDebugParams.ThrottleOverride, TEXT("Hard code throttle input on."));
FAutoConsoleVariableRef CVarChaosVehiclesSteeringOverride(TEXT("p.Vehicle.SteeringOverride"), GTrakcedVehicleDebugParams.SteeringOverride, TEXT("Hard code steering input on."));

FAutoConsoleVariableRef CVarChaosVehiclesResetMeasurements(TEXT("p.Vehicle.ResetMeasurements"), GTrakcedVehicleDebugParams.ResetPerformanceMeasurements, TEXT("Reset Vehicle Performance Measurements."));

FAutoConsoleVariableRef CVarChaosVehiclesOverlapTestExpansionXY(TEXT("p.Vehicle.OverlapTestExpansionXY"), GTrakcedVehicleDebugParams.OverlapTestExpansionXY, TEXT("Raycast Overlap Test Expansion of Bounding Box in X/Y axes."));
FAutoConsoleVariableRef CVarChaosVehiclesOverlapTestExpansionXZ(TEXT("p.Vehicle.OverlapTestExpansionZ"), GTrakcedVehicleDebugParams.OverlapTestExpansionZ, TEXT("Raycast Overlap Test Expansion of Bounding Box in Z axis"));

//FAutoConsoleVariableRef CVarChaosVehiclesDisableSuspensionConstraints(TEXT("p.Vehicle.DisableSuspensionConstraint"), GTrakcedVehicleDebugParams.DisableSuspensionConstraint, TEXT("Enable/Disable Suspension Constraints."));
...
FAutoConsoleCommand CVarCommandVehiclesNextDebugPage(
	...
	FConsoleCommandDelegate::CreateStatic(UChaosTrackedVehicleMovementComponent::NextDebugPage));
...
FAutoConsoleCommand CVarCommandVehiclesPrevDebugPage(
	...
	FConsoleCommandDelegate::CreateStatic(UChaosTrackedVehicleMovementComponent::PrevDebugPage));


FString FTrackedWheelStatus::ToString() const
{
...
void FTrackedWheelState::CaptureState(int WheelIdx, const FVector& WheelOffset, const FBodyInstance* TargetInstance)
{
...
void FTrackedWheelState::CaptureState(int WheelIdx, const FVector& WheelOffset, const Chaos::FRigidBodyHandle_Internal* Handle)
{
	check(Handle);
...
void FTrackedWheelState::CaptureState(int WheelIdx, const FVector& WheelOffset, const Chaos::FRigidBodyHandle_Internal* VehicleHandle, const FVector& ContactPoint, const Chaos::FRigidBodyHandle_Internal* SurfaceHandle)
{
	check(VehicleHandle);
...
FVector FTrackedWheelState::GetVelocityAtPoint(const Chaos::FRigidBodyHandle_Internal* Rigid, const FVector& InPoint)
{
	if (Rigid)
	{
 ...
 */
bool UChaosTrackedVehicleSimulation::CanSimulate() const
{
...
void UChaosTrackedVehicleSimulation::TickVehicle(UWorld* WorldIn, float DeltaTime, const FChaosVehicleAsyncInput& InputData, FChaosVehicleAsyncOutput& OutputData, Chaos::FRigidBodyHandle_Internal* Handle)
{
...
void UChaosTrackedVehicleSimulation::UpdateState(float DeltaTime, const FChaosVehicleAsyncInput& InputData, Chaos::FRigidBodyHandle_Internal* Handle)
{
	...
	if (CanSimulate() && Handle)
	{
		...
		if (!GTrakcedVehicleDebugParams.DisableSuspensionForces && PVehicle->bSuspensionEnabled)
		{
...
void UChaosTrackedVehicleSimulation::UpdateSimulation(float DeltaTime, const FChaosVehicleAsyncInput& InputData, Chaos::FRigidBodyHandle_Internal* Handle)
{
	...
	if (CanSimulate() && Handle)
	{
		///////////////////////////////////////////////////////////////////////
		// Engine/Transmission
		if (!GTrakcedVehicleDebugParams.DisableSuspensionForces && PVehicle->bMechanicalSimEnabled)
		{
		...
		if (!GTrakcedVehicleDebugParams.DisableFrictionForces && PVehicle->bWheelFrictionEnabled)
		{
...
bool UChaosTrackedVehicleSimulation::ContainsTraces(const FBox& Box, const TArray<Chaos::FSuspensionTrace>& SuspensionTrace)
{
...
void UChaosTrackedVehicleSimulation::PerformSuspensionTraces(const TArray<Chaos::FSuspensionTrace>& SuspensionTrace, FCollisionQueryParams& TraceParams, FCollisionResponseContainer& CollisionResponse, TArray<FWheelTraceParams>& WheelTraceParams)
{
	...
	if (GVehicleDebugParams.BatchQueries)
	{
		if (!GVehicleDebugParams.CacheTraceOverlap || !ContainsTraces(QueryBox, SuspensionTrace))
		{
			...
			QueryBox = QueryBox.ExpandBy(FVector(GTrakcedVehicleDebugParams.OverlapTestExpansionXY, GTrakcedVehicleDebugParams.OverlapTestExpansionXY, GTrakcedVehicleDebugParams.OverlapTestExpansionZ));
	...
	#if !(UE_BUILD_SHIPPING || UE_BUILD_TEST)
		if (GTrakcedVehicleDebugParams.ShowBatchQueryExtents)
		{
		...
		for (int32 WheelIdx = 0; WheelIdx < SuspensionTrace.Num(); ++WheelIdx)
		{
			...
			if (bOverlapHit)
			{
				...
				if (GTrakcedVehicleDebugParams.TraceTypeOverride > 0)
				{
					TraceParams.bTraceComplex = GTrakcedVehicleDebugParams.TraceTypeOverride == 2;
				}
...
void UChaosTrackedVehicleSimulation::ApplyWheelFrictionForces(float DeltaTime)
{
...
#if !(UE_BUILD_SHIPPING || UE_BUILD_TEST)
			if (GTrakcedVehicleDebugParams.ShowTrackForces)
			{
...
void UChaosTrackedVehicleSimulation::ApplySuspensionForces(float DeltaTime, TArray<FWheelTraceParams>& WheelTraceParams)
{
	using namespace Chaos;
	...
	for (int WheelIdx = 0; WheelIdx < SusForces.Num(); WheelIdx++)
	{
		...
		if (!GTrakcedVehicleDebugParams.DisableConstraintSuspension)
		{
				...
				if (ConstraintHandle.IsValid())
				{
					if (Chaos::FSuspensionConstraint* Constraint = static_cast<Chaos::FSuspensionConstraint*>(ConstraintHandle.Constraint))
					{
						if (FSuspensionConstraintPhysicsProxy* Proxy = Constraint->GetProxy<FSuspensionConstraintPhysicsProxy>())
						{
							...
							Solver->SetSuspensionTarget(Constraint, TargetPos, HitResult.Normal, PWheel.InContact());
						}
					}
				}
			}
...
#if !(UE_BUILD_SHIPPING || UE_BUILD_TEST)
			if (GTrakcedVehicleDebugParams.ShowSuspensionForces)
			{
	...
	if (!GTrakcedVehicleDebugParams.DisableRollbarForces)
	{
...
void UChaosTrackedVehicleSimulation::ProcessSteering(const FControlInputs& ControlInputs)
{
	using namespace Chaos;
	...
	for (int WheelIdx = 0; WheelIdx < PVehicle->Wheels.Num(); WheelIdx++)
	{
		...
		if (PWheel.SteeringEnabled)
		{
			...
			if (FMath::Abs(GTrakcedVehicleDebugParams.SteeringOverride) > 0.01f)
			{
				SteeringAngle = PWheel.MaxSteeringAngle * GTrakcedVehicleDebugParams.SteeringOverride;
			}
			else
			{
...
void UChaosTrackedVehicleSimulation::ApplyInput(const FControlInputs& ControlInputs, float DeltaTime)
{
	using namespace Chaos;
	...
	if (PVehicle->HasTransmission() && PVehicle->HasEngine())
	{
		...
		if (GTrakcedVehicleDebugParams.ThrottleOverride > 0.f)
		{
			PTransmission.SetGear(1, true);
			ModifiedInputs.BrakeInput = 0.f;
			PEngine.SetThrottle(GTrakcedVehicleDebugParams.ThrottleOverride);
		}
		else
		{
...
bool UChaosTrackedVehicleSimulation::IsWheelSpinning() const
{
...
void UChaosTrackedVehicleSimulation::ProcessMechanicalSimulation(float DeltaTime)
{
	using namespace Chaos;
...
void UChaosTrackedVehicleSimulation::DrawDebug3D()
{
	using namespace Chaos;
	...
	if (GTrakcedVehicleDebugParams.ShowSuspensionLimits)
	{
		for (int WheelIdx = 0; WheelIdx < PVehicle->Suspension.Num(); WheelIdx++)
		{
			auto& PSuspension = PVehicle->Suspension[WheelIdx];
	...
	if (GTrakcedVehicleDebugParams.ShowRaycastComponent)
	{
		for (int WheelIdx = 0; WheelIdx < PVehicle->Suspension.Num(); WheelIdx++)
		{
	...
	if (GTrakcedVehicleDebugParams.ShowRaycastMaterial)
	{
		for (int WheelIdx = 0; WheelIdx < PVehicle->Suspension.Num(); WheelIdx++)
		{
			FHitResult& Hit = WheelState.TraceResult[WheelIdx];
	...
	if (GTrakcedVehicleDebugParams.ShowTrackCollisionNormal)
	{
		FString Name;
		for (int WheelIdx = 0; WheelIdx < PVehicle->Suspension.Num(); WheelIdx++)
		{
	...
	if (GTrakcedVehicleDebugParams.ShowSuspensionRaycasts)
	{
		for (int WheelIdx = 0; WheelIdx < PVehicle->Suspension.Num(); WheelIdx++)
		{
...
void UChaosTrackedVehicleSimulation::FillOutputState(FChaosVehicleAsyncOutput& Output)
{
...
UChaosTrackedVehicleSimulation::UChaosTrackedVehicleSimulation(): bOverlapHit(false)
{
	QueryBox.Init();
}

UChaosTrackedVehicleSimulation::~UChaosTrackedVehicleSimulation()
{
}

void UChaosTrackedVehicleSimulation::UpdateConstraintHandles(TArray<FPhysicsConstraintHandle>& ConstraintHandlesIn)
{
...
UChaosTrackedVehicleMovementComponent::UChaosTrackedVehicleMovementComponent(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
...
// Public
void UChaosTrackedVehicleMovementComponent::Serialize(FArchive & Ar)
{
	Super::Serialize(Ar);
...
void UChaosTrackedVehicleMovementComponent::PostLoad()
{
	Super::PostLoad();
...
#if WITH_EDITOR
void UChaosTrackedVehicleMovementComponent::PostEditChangeProperty(struct FPropertyChangedEvent& PropertyChangedEvent)
{
...
void UChaosTrackedVehicleMovementComponent::FixupSkeletalMesh()
{
	...
	if (USkeletalMeshComponent* Mesh = Cast<USkeletalMeshComponent>(GetMesh()))
	{
		if (UPhysicsAsset* PhysicsAsset = Mesh->GetPhysicsAsset())
		{
			...
			{
				FChaosTrackedWheelSetup& WheelSetup = WheelSetups[WheelIdx];
...
bool UChaosTrackedVehicleMovementComponent::CanCreateVehicle() const
{
	...
	for (int32 WheelIdx = 0; WheelIdx < WheelSetups.Num(); ++WheelIdx)
	{
		const FChaosTrackedWheelSetup& WheelSetup = WheelSetups[WheelIdx];
...
void UChaosTrackedVehicleMovementComponent::OnCreatePhysicsState()
{
	Super::OnCreatePhysicsState();
}

void UChaosTrackedVehicleMovementComponent::CreateVehicle()
{
	Super::CreateVehicle();
	...
	if (PVehicleOutput)
	{
		...
		{
			MeshOnPhysicsStateChangeHandle = MeshComp->RegisterOnPhysicsCreatedDelegate(FOnSkelMeshPhysicsCreated::CreateUObject(this, &UChaosTrackedVehicleMovementComponent::RecreatePhysicsState));
			if (UTrackedVehicleAnimationInstance* VehicleAnimInstance = Cast<UTrackedVehicleAnimationInstance>(MeshComp->GetAnimInstance()))
			{
				VehicleAnimInstance->SetTrackedVehicleComponent(this);
			}
		}
	}
...
void UChaosTrackedVehicleMovementComponent::OnDestroyPhysicsState()
{
...
void UChaosTrackedVehicleMovementComponent::NextDebugPage()
{
...
void UChaosTrackedVehicleMovementComponent::PrevDebugPage()
{
	int PageAsInt = (int)DebugPage;
	PageAsInt--;
	if (PageAsInt < 0)
...
// Setup
void UChaosTrackedVehicleMovementComponent::ComputeConstants()
{
	Super::ComputeConstants();
}

void UChaosTrackedVehicleMovementComponent::CreateWheels()
{
...
void UChaosTrackedVehicleMovementComponent::DestroyWheels()
{
...
void UChaosTrackedVehicleMovementComponent::SetupVehicle(TUniquePtr<Chaos::FSimpleWheeledVehicle>& PVehicle)
{
	using namespace Chaos;
	...
	for (int32 WheelIdx = 0; WheelIdx < WheelSetups.Num(); ++WheelIdx)
	{
		...
		if (Wheel->GetAxleType() != EAxleType::Undefined)
		{
			...
			{
				if (DifferentialSetup.DifferentialType == ETrackedVehicleDifferential::AllWheelDrive
					|| DifferentialSetup.DifferentialType == ETrackedVehicleDifferential::FrontWheelDrive)
				{
					EngineEnable = true;
				}
			}
			...
			{
				if (DifferentialSetup.DifferentialType == ETrackedVehicleDifferential::AllWheelDrive
					|| DifferentialSetup.DifferentialType == ETrackedVehicleDifferential::RearWheelDrive)
				{
					EngineEnable = true;
				}
			}
	...
	for (auto& Axle : AxleToWheelMap)
	{
		...
		FChaosTrackedWheelSetup& WheelSetup = WheelSetups[WheelIndices[0]];
	...
	if (EngineSetup.TorqueCurve.GetRichCurve()->IsEmpty())
	{
		...
		UE_LOG(LogVehicle, Log, TEXT("Vehicle %s has no torque curve defined, disabling mechanical simulation."), *ActorName);
	...
	if (bMechanicalSimEnabled)
	{
		...
		ChaosTracked::FTrackedDifferentialSim DifferentialSim(&DifferentialSetup.GetPhysicsDifferentialConfig());
...
void UChaosTrackedVehicleMovementComponent::ResetVehicleState()
{
	UChaosVehicleMovementComponent::ResetVehicleState();

	for (FTrackedWheelStatus& WheelInfo : WheelStatus)
	{
		WheelInfo.Init();
	}
...
void UChaosTrackedVehicleMovementComponent::SetupVehicleShapes()
{
	if (!UpdatedPrimitive)
	{
		return;
...
void UChaosTrackedVehicleMovementComponent::SetupSuspension(TUniquePtr<Chaos::FSimpleWheeledVehicle>& PVehicle)
{
...
void UChaosTrackedVehicleMovementComponent::RecalculateAxles()
{
...
FVector UChaosTrackedVehicleMovementComponent::GetWheelRestingPosition(const FChaosTrackedWheelSetup& WheelSetup)
{
...
// Access to data
float UChaosTrackedVehicleMovementComponent::GetEngineRotationSpeed() const
{
	float EngineRPM = 0.f;
...
float UChaosTrackedVehicleMovementComponent::GetEngineMaxRotationSpeed() const
{
...
// Helper
FVector2D UChaosTrackedVehicleMovementComponent::CalculateWheelLayoutDimensions()
{
...
void UChaosTrackedVehicleMovementComponent::Update(float DeltaTime)
{
...
// Debug
void UChaosTrackedVehicleMovementComponent::DrawDebug(UCanvas* Canvas, float& YL, float& YPos)
{
	using namespace Chaos;
	...
	{
		if (GTrakcedVehicleDebugParams.ResetPerformanceMeasurements)
		{
			GTrakcedVehicleDebugParams.ResetPerformanceMeasurements = false;
...
//			}
	...
	if (DebugPage == EDebugPages::TransmissionPage && bMechanicalSimEnabled)
	{
		...
		{
			const float GearRatio = TSetup.GetGearRatio(Gear);
			check(GearRatio != 0.f);

			for (int EngineRPM = 0; EngineRPM <= ESetup.MaxRPM; EngineRPM += 10)
			{
				float RPMOut = EngineRPM / GearRatio;
...
float UChaosTrackedVehicleMovementComponent::CalcDialAngle(float CurrentValue, float MaxValue)
{
	return (CurrentValue / MaxValue) * 3.f / 2.f * PI - (PI * 0.25f);
}

void UChaosTrackedVehicleMovementComponent::DrawDial(UCanvas* Canvas, FVector2D Pos, float Radius, float CurrentValue, float MaxValue)
{
...
void UChaosTrackedVehicleMovementComponent::FillWheelOutputState()
{
	if (const FChaosVehicleAsyncOutput* CurrentOutput = static_cast<FChaosVehicleAsyncOutput*>(CurAsyncOutput))
	{
		if (CurrentOutput->bValid && PVehicleOutput)
		{
			for (int WheelIdx = 0; WheelIdx < WheelStatus.Num(); WheelIdx++)
			{
				...
				FTrackedWheelStatus& State = WheelStatus[WheelIdx];
...
void UChaosTrackedVehicleMovementComponent::BreakWheelStatus(const struct FTrackedWheelStatus& Status, bool& bInContact, FVector& ContactPoint, UPhysicalMaterial*& PhysMaterial
...
FTrackedWheelStatus UChaosTrackedVehicleMovementComponent::MakeWheelStatus(bool bInContact, FVector& ContactPoint, UPhysicalMaterial* PhysMaterial
	, float NormalizedSuspensionLength, float SpringForce, float SlipAngle, bool bIsSlipping, float SlipMagnitude, bool bIsSkidding, float SkidMagnitude, FVector& SkidNormal, float DriveTorque, float BrakeTorque, bool bABSActivated)
{
	FTrackedWheelStatus Status;
...
void UChaosTrackedVehicleMovementComponent::BreakWheeledSnapshot(const struct FWheeledSnaphotData& Snapshot, FTransform& Transform, FVector& LinearVelocity
...
FWheeledSnaphotData UChaosTrackedVehicleMovementComponent::MakeWheeledSnapshot(FTransform Transform, FVector LinearVelocity
...
void UChaosTrackedVehicleMovementComponent::BreakWheelSnapshot(const struct FWheelSnapshot& Snapshot, float& SuspensionOffset
...
FWheelSnapshot UChaosTrackedVehicleMovementComponent::MakeWheelSnapshot(float SuspensionOffset, float WheelRotationAngle
...
void UChaosTrackedVehicleMovementComponent::ParallelUpdate(float DeltaSeconds)
{
...
void UChaosTrackedVehicleMovementComponent::SetWheelClass(int WheelIndex, TSubclassOf<UChaosVehicleWheel> InWheelClass)
{
...
FWheeledSnaphotData UChaosTrackedVehicleMovementComponent::GetSnapshot() const
{
...
void UChaosTrackedVehicleMovementComponent::SetSnapshot(const FWheeledSnaphotData& SnapshotIn)
{
...
void UChaosTrackedVehicleMovementComponent::SetMaxEngineTorque(float Torque)
{
...
void UChaosTrackedVehicleMovementComponent::SetDragCoefficient(float DragCoeff)
{
	if (FBodyInstance* TargetInstance = GetBodyInstance())
	{
		FPhysicsCommand::ExecuteWrite(TargetInstance->GetPhysicsActor(), [&](const FPhysicsActorHandle& Chassis)
...
void UChaosTrackedVehicleMovementComponent::SetDownforceCoefficient(float DownforceCoeff)
{
	if (FBodyInstance* TargetInstance = GetBodyInstance())
	{
		FPhysicsCommand::ExecuteWrite(TargetInstance->GetPhysicsActor(), [&](const FPhysicsActorHandle& Chassis)
...
void UChaosTrackedVehicleMovementComponent::SetDifferentialFrontRearSplit(float FrontRearSplit)
{
	if (FBodyInstance* TargetInstance = GetBodyInstance())
	{
		FPhysicsCommand::ExecuteWrite(TargetInstance->GetPhysicsActor(), [&](const FPhysicsActorHandle& Chassis)
...
void UChaosTrackedVehicleMovementComponent::SetTractionControlEnabled(int WheelIndex, bool Enabled)
{
	if (FBodyInstance* TargetInstance = GetBodyInstance())
	{
		FPhysicsCommand::ExecuteWrite(TargetInstance->GetPhysicsActor(), [&](const FPhysicsActorHandle& Chassis)
...
void UChaosTrackedVehicleMovementComponent::SetABSEnabled(int WheelIndex, bool Enabled)
{
	if (FBodyInstance* TargetInstance = GetBodyInstance())
	{
		FPhysicsCommand::ExecuteWrite(TargetInstance->GetPhysicsActor(), [&](const FPhysicsActorHandle& Chassis)
...
void UChaosTrackedVehicleMovementComponent::SetAffectedByBrake(int WheelIndex, bool Enabled)
{
	if (FBodyInstance* TargetInstance = GetBodyInstance())
	{
		FPhysicsCommand::ExecuteWrite(TargetInstance->GetPhysicsActor(), [&](const FPhysicsActorHandle& Chassis)
...
void UChaosTrackedVehicleMovementComponent::SetAffectedByHandbrake(int WheelIndex, bool Enabled)
{
	if (FBodyInstance* TargetInstance = GetBodyInstance())
	{
		FPhysicsCommand::ExecuteWrite(TargetInstance->GetPhysicsActor(), [&](const FPhysicsActorHandle& Chassis)
...
void UChaosTrackedVehicleMovementComponent::SetAffectedBySteering(int WheelIndex, bool Enabled)
{
	if (FBodyInstance* TargetInstance = GetBodyInstance())
	{
		FPhysicsCommand::ExecuteWrite(TargetInstance->GetPhysicsActor(), [&](const FPhysicsActorHandle& Chassis)
...
void UChaosTrackedVehicleMovementComponent::SetAffectedByEngine(int WheelIndex, bool Enabled)
{
	if (FBodyInstance* TargetInstance = GetBodyInstance())
	{
		FPhysicsCommand::ExecuteWrite(TargetInstance->GetPhysicsActor(), [&](const FPhysicsActorHandle& Chassis)
...
void UChaosTrackedVehicleMovementComponent::SetWheelRadius(int WheelIndex, float Radius)
{
	if (FBodyInstance* TargetInstance = GetBodyInstance())
	{
		FPhysicsCommand::ExecuteWrite(TargetInstance->GetPhysicsActor(), [&](const FPhysicsActorHandle& Chassis)
...
void UChaosTrackedVehicleMovementComponent::SetWheelFrictionMultiplier(int WheelIndex, float Friction)
{
	if (FBodyInstance* TargetInstance = GetBodyInstance())
	{
		FPhysicsCommand::ExecuteWrite(TargetInstance->GetPhysicsActor(), [&](const FPhysicsActorHandle& Chassis)
...
void UChaosTrackedVehicleMovementComponent::SetWheelSlipGraphMultiplier(int WheelIndex, float Multiplier)
{
	if (FBodyInstance* TargetInstance = GetBodyInstance())
	{
		FPhysicsCommand::ExecuteWrite(TargetInstance->GetPhysicsActor(), [&](const FPhysicsActorHandle& Chassis)
...
void UChaosTrackedVehicleMovementComponent::SetWheelMaxBrakeTorque(int WheelIndex, float Torque)
{
	if (FBodyInstance* TargetInstance = GetBodyInstance())
	{
		FPhysicsCommand::ExecuteWrite(TargetInstance->GetPhysicsActor(), [&](const FPhysicsActorHandle& Chassis)
...
void UChaosTrackedVehicleMovementComponent::SetWheelHandbrakeTorque(int WheelIndex, float Torque)
{
	if (FBodyInstance* TargetInstance = GetBodyInstance())
	{
		FPhysicsCommand::ExecuteWrite(TargetInstance->GetPhysicsActor(), [&](const FPhysicsActorHandle& Chassis)
...
void UChaosTrackedVehicleMovementComponent::SetWheelMaxSteerAngle(int WheelIndex, float AngleDegrees)
{
	if (FBodyInstance* TargetInstance = GetBodyInstance())
	{
		FPhysicsCommand::ExecuteWrite(TargetInstance->GetPhysicsActor(), [&](const FPhysicsActorHandle& Chassis)
...
void UChaosTrackedVehicleMovementComponent::SetTorqueCombineMethod(ETorqueCombineMethod InCombineMethod, int32 WheelIndex)
{
	if (FBodyInstance* TargetInstance = GetBodyInstance())
	{
		FPhysicsCommand::ExecuteWrite(TargetInstance->GetPhysicsActor(), [&](const FPhysicsActorHandle& Chassis)
...
void UChaosTrackedVehicleMovementComponent::SetDriveTorque(float DriveTorque, int32 WheelIndex)
{
	using namespace Chaos;
...
void UChaosTrackedVehicleMovementComponent::SetBrakeTorque(float BrakeTorque, int32 WheelIndex)
{
	using namespace Chaos;
...
void UChaosTrackedVehicleMovementComponent::SetSuspensionParams(float Rate, float Damping, float Preload, float MaxRaise, float MaxDrop, int32 WheelIndex)
{
	using namespace Chaos;
		...
		FPhysicsCommand::ExecuteWrite(TargetInstance->GetPhysicsActor(), [&](const FPhysicsActorHandle& Chassis)
			{
				...
				{
					FChaosTrackedWheelSetup& WheelSetup = WheelSetups[WheelIndex];
					const FVector LocalWheel = GetWheelRestingPosition(WheelSetup);
					FPhysicsConstraintHandle ConstraintHandle = FPhysicsInterface::CreateSuspension(Chassis, LocalWheel);
...
float UChaosTrackedVehicleMovementComponent::GetSuspensionOffset(int WheelIndex)
{
	float Offset = 0.f;
	...
	if (GetBodyInstance())
	{
		...
		{
			if (GTrakcedVehicleDebugParams.CacheSuspensionOffset && WheelStatus[WheelIndex].bIsValid)
			{
...
UPhysicalMaterial* UChaosTrackedVehicleMovementComponent::GetPhysMaterial(int WheelIndex)
{
	return WheelStatus[WheelIndex].PhysMaterial.Get();
}


FChaosTrackedWheelSetup::FChaosTrackedWheelSetup()
...
FTrackedWheelState::FTrackedWheelState()
{
}
...
FTrackedWheelState::FTrackedWheelState(const FTrackedWheelState& Other): WheelLocalLocation(Other.WheelLocalLocation),
...
FTrackedWheelState& FTrackedWheelState::operator=(const FTrackedWheelState& Other)
{
	if (this == &Other)
		return *this;
...
void FTrackedWheelState::Init(int NumWheels)
{
