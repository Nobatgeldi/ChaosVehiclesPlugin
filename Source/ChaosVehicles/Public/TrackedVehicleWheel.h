...
#include "TrackedVehicleWheel.generated.h"
...
UCLASS(BlueprintType, Blueprintable)
	class CHAOSVEHICLES_API UTrackedVehicleWheel : public UObject
{
	...
	*/
	...
	UPROPERTY(transient)
	TObjectPtr<class UChaosTrackedVehicleMovementComponent> VehicleComponent;
	...
	void Init(UChaosTrackedVehicleMovementComponent* InVehicleSim, int32 InWheelIndex);
	 ...
	 */
	struct FChaosTrackedWheelSetup& GetWheelSetup();
